...
<head>
    ...
    <link rel="stylesheet" href="heart.scss">
...
<body>
    <section class="showcase">
        ...
        <div class="apod">
            <!-- <div class="apod-text">
                ...
                <h3>Brought To You by Nasa's API Generator</h3>
            </div> -->
            <div class="card">
        ...
        <!-- <div class="text">
            <h2>Image Sharing</h2>
            <h3>From The Final Frontier</h3>
            <p>Brought to you by NASA's Astronomy Picture of the Day (APOD) API. Click the button below
                for the most recent astronomy pictures of the day.
            </p>
    ...
    <script>
     ...
     // checks for response from server in order to execute action 
