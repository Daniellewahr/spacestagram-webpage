...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="column-md-8 mb-4 mb-md-0">
          <div class="about center">
            <h1>Spacestagram: APOD</h1>
            <h3>Image Sharing from The Final Frontier</h3>
            <h7 class="text-muted">Brought to you by NASA's Astronomy Picture of the Day (APOD) API</h7>
            <p></p>
          </div>
    ...
    <footer class="footer">
      <p> © 2022 Version 0.1.1 by Danielle Wahrhaftig </p>
    </footer>
